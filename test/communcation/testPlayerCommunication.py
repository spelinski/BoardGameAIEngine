...
class TestPlayerCommunication(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.workingBotWithPath = "{} test/mockBot/mockBot.py".format(sys.executable)
    ...
    def test_should_always_send_without_timout_valid_program(self):
        localPlayerCommunication = PlayerCommunication(self.workingBot, self.workingDir)
    ...
    def test_should_always_send_without_timout_invalid_program(self):
        localPlayerCommunication = PlayerCommunication(self.nonExistantBot, self.workingDir)
        time.sleep(1)
